...
$(document).ready(function () {
    $('.header-main__parallax-list>li').addClass('layer');
    $('.header-main__parallax-list').parallax();

    $('.features__parallax-list>li').addClass('layer');
    $('.features__parallax-list').parallax();

    $('.designed__parallax-list>li').addClass('layer');
    $('.designed__parallax-list').parallax();

    $('.ultimate__parallax-list>li').addClass('layer');
    $('.ultimate__parallax-list').parallax();

    $('.testimonials__parallax-list>li').addClass('layer');
    $('.testimonials__parallax-list').parallax();
...
$("#toggle-on").click(function () {
    $(".card-price-month").css("display", "flex");
    $(".card-price-annually").css("display", "none");
})
$("#toggle-off").click(function () {
    $(".card-price-month").css("display", "none");
    $(".card-price-annually").css("display", "flex");
})
...
// init Swiper
let myImageSlider = new Swiper('.card-slider', {
    ...
    keyboard: {
        // enable / disable
        enabled: true,
        // enable / disable only when swiper on viewport
        onlyInViewport: true,
        // enable / disable pgup/pbdown swipe
        pageUpDown: true,
    },


    // count slides per view
    slidesPerView: 2,

    // disable swiper when slides is less than need
    watchOverflow: true,

    // margin below slides
    spaceBetween: 30,

    // count of swiped slides
    slidesPerGroup: 1,
...
let myImageSliderTestimonials = new Swiper('.testimonials-slider', {
...
let myImageSliderTrusted = new Swiper('.trusted-slider', {
...
function menu_close() {
	let iconMenu = document.querySelector(".icon-menu");
	let menuBody = document.getElementsByClassName(".menu__body");
